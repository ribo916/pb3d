...
export function renderScript(onChange) {
  ...
  state.script.forEach((entry, i) => {
    ...
    toggle.title = 'Who heads where the instant this shot fires — expand to add a cue';
    toggle.textContent = (expanded ? '▾' : '▸') + ' Moves (' + moves.length + ')';
