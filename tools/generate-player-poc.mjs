...
clips.push(new THREE.AnimationClip('forehand', 0.44, [
  quatTrack('torso', [0, 0.22, 0.44], [[0, -0.34, 0.02], [0, 0.22, -0.08], [0, 0.1, 0]]),
  quatTrack('hips', [0, 0.22, 0.44], [[0, -0.08, 0], [0, 0.08, 0], [0, 0, 0]])
]));
...
clips.push(new THREE.AnimationClip('serve', 0.44, [
  quatTrack('torso', [0, 0.22, 0.44], [[0.05, -0.12, 0], [-0.16, 0.1, 0], [0.02, 0, 0]])
]));
