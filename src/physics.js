...
import { FT, COURT, PHYS_V2, STABILITY } from './constants.js';
...
export function makeBall() {
  return {
    ...
    flight: null        // {landing,T,apexY,samples,elapsed} cached solver result
  };
}

/* ============================================================================
 * Simulated flight + numeric shot solver.
 *
